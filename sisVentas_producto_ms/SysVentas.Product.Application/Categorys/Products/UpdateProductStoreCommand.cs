...
namespace SysVentas.Products.Application.Categorys.Products
{
    public class UpdateProductStoreCommand : IRequestHandler<UpdateProductStoreRequest, UpdateProductStoreResponse>
    {
        ...
        private List<Domain.Entities.Categorys.Product> ObtenerProduct(List<ProductStoreModelView> productStoreModelViews) {
    ...
    {
        private readonly IUnitOfWork _unitOfWork;
        public Domain.Entities.Categorys.Product Product { get; set; }
